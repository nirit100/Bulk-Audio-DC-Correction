...
def main():
    ...
    parser.add_argument('--smoothing', type=float, default=0.02, help='Transition width for symmetry blending near zero, to avoid distortion from hard correction (0..1; default: 0.02)')
